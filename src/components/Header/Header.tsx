    ...
    <>
      <header className={styles["header"]}>
        <button className={styles["header__menu-button"]}>
          <img src="img/icons/menu-icon.png" alt="Иконка меню" />
        </button>
        <img
        ...
        <div className={styles["header-search"]}>
          <label className={styles["header-search__label"]}>
            <input
          ...
          <button className={styles["header-search__button"]}>
            <img src="/img/icons/search-icon.png" alt="Иконка поиска" />
          </button>
        </div>
        <button className={styles["header__search-button"]}>
          <img src="/img/icons/search-icon.png" alt="Иконка поиска" />
        </button>
        <button className={styles["header__more-button"]}>
          <img src="/img/icons/more-icon.png" alt="Иконка меню" />
        </button>
        <div className={styles["header__buttons-container"]}>
          ...
          <button
            className={classnames(styles["header__button"], styles["header__notification-button"])}
          >
            <svg
              width="22"
              height="26"
            ...
            <div className={styles["notification-button__counter"]}>3</div>
          </button>
        </div>
        <div className={styles["header-profile"]}>
          <img
            className="media-fit"
            src="/img/avatars/header-avatar.webp"
            alt="Иконка профиля"
          />
        </div>
      </header>
